...
blink::WebMediaPlayer* MediaFactory::CreateMediaPlayer(
    ...
    const cc::LayerTreeSettings& settings) {
  std::cout << "[MediaFactory::CreateMediaPlayer]" << std::endl;
  ...
  std::cout << "[MediaFactory::CreateMediaPlayer] not returned " <<std::endl;
  ...
  media::WebMediaPlayerImpl* media_player = new media::WebMediaPlayerImpl(
      ...
      std::move(params));
  std::cout << "[] media_player impl created" <<std::endl;
  return media_player;
}
