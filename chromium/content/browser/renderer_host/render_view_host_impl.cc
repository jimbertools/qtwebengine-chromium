...
RenderViewHostImpl::RenderViewHostImpl(
  ...
  // std::cout << "[RenderViewHostImpl::ctor]" << std::endl;
...
bool RenderViewHostImpl::CreateRenderView(
  ...
  // std::cout << "[RenderViewHostImpl::CreateRenderView]" <<std::endl;
...
const WebPreferences RenderViewHostImpl::ComputeWebPreferences() {
  ...
  prefs.accelerated_2d_canvas_msaa_sample_count = atoi(
      command_line
          .GetSwitchValueASCII(switches::kAcceleratedCanvas2dMSAASampleCount)
          .c_str());
