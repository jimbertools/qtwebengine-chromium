...
void HTMLImageElement::ParseAttribute(
  ...
  // jimber
  // blink::ImageResourceContent* imgResource = CachedImage();
  // std::cout
  //     << "[ImageResourceContent::UpdateToLoadedContentStatus] imgResource "
  //     << imgResource << std::endl;
  // if (imgResource) {
  //   if (imgResource->Url().ProtocolIs("blob:")) {
  //     std::cout
  //         << "[ImageResourceContent::UpdateToLoadedContentStatus] blob found"
  //         << std::endl;
  //     // JCommandHandler::instance().sendImageWithBlobUrl(
  //     //     imgResource->GetImage(), imgResource->Url().GetString().Utf8(),
  //     //     imgResource->GetResponse().MimeType().Utf8());
  //   }
  // }
  //
}
...
void HTMLImageElement::StartLoadingImageDocument(
  ...
  std::cout << "[HTMLImageElement::StartLoadingImageDocument]" << std::endl;
