...
#ifdef JIMBERENABLED
  JCommandHandler::instance().sendSetChecked(this, now_checked);
#endif
...
void HTMLInputElement::SetValueForUser(const String& value) {
  std::cout << "HTMLInputElement::SetValueForUser" << std::endl;
...
void HTMLInputElement::SetEditingValue(const String& value) {
  std::cout << "seteditingvalue " << value << std::endl;
...
#ifdef JIMBERENABLED
  // if(isConnected() && !TreeRoot().IsDocumentFragment()) {
  JCommandHandler::instance().sendSetValue(this, value.Utf8());
// }
#endif
...
void HTMLInputElement::setValueAsNumber(double new_value,
                                        ExceptionState& exception_state,
                                        TextFieldEventBehavior event_behavior) {
  std::cout << "[HTMLInputElement::setValueAsNumber]" << std::endl;
