...
#ifdef JIMBERENABLED
  JCommandHandler::instance().sendDeleteNode(this);
#endif
}
...
void Node::setTextContent(const StringOrTrustedScript& string_or_trusted_script,
                          ExceptionState& exception_state) {
  String value = string_or_trusted_script.IsString()
...
#ifdef JIMBERENABLED
  JCommandHandler::instance().sendSetFocus(this, flag);
#endif
