...
class WebSourceBufferImpl : public blink::WebSourceBuffer {
 public:
  ...
  void setWindowId(int id) { windowId_ = id; };
  int getWindowId() { return windowId_; };
  void setMediaSourceId(const std::string& id) { mediaSourceId_ = id; }
  //
